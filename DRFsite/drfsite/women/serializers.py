...
# реализация сериализатора на основе моделей и (класса ModelSerializer)
class WomenSerializer(serializers.ModelSerializer):
    class Meta:
        model = Women
        fields = '__all__'
        # fields = ('title', 'content') поля которые будут обратно возвращаться клиенту
...
# реализация сериализатора на основе класса Serializer
